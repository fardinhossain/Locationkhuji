...
const HeroSearch = () => {
  ...
  return (
    <motion.div
      ...
      className="hero-search-wrapper w-full max-w-2xl mt-6"
    >
      ...
      {/* Hint Text */}
      <p className="hero-search-hint text-gray-500 text-[11px] font-medium mb-3 ml-1 transition-all duration-300">
        {mode === "ai" ? t('aiModeHint') : t('standardModeHint')}
      </p>

      {/* Search Input Container */}
      <form onSubmit={handleSearch} className={`hero-search-form relative flex items-center w-full bg-[#11161C] border rounded-full p-2 pl-2 sm:pl-6 shadow-2xl transition-colors focus-within:ring-1 ${mode === "ai"
        ...
        />
        <button type="submit" className="hero-search-btn bg-teal-500 hover:bg-teal-400 text-navy-900 font-semibold px-4 sm:px-6 py-2 sm:py-2.5 rounded-full flex items-center gap-1.5 sm:gap-2 transition-colors shadow-[0_0_15px_rgba(0,209,178,0.4)] whitespace-nowrap text-sm sm:text-base flex-shrink-0">
      ...
      {/* Popular Areas */}
      <div className="hero-search-popular flex flex-wrap items-center gap-3 mt-6">
